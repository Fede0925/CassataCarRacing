...
//	immagini e git della finestra seleziona difficoltà
...
//	immagini della finestra di gioco e selezione del veicolo
...
//	immagini della schermata principale
...
//		posizione oggetti della schermata principale
		titoloW.setX(200);
		titoloW.setY(25);
		apri.setLayoutX(350);
		apri.setLayoutY(435);
...
//		id css dei pulstanti e del titolo
		apri.setId("gioca");
...
//		variabili macchina giocatore
		int rotazione = 0;
		double x = 10;
		Boolean veicolo = false;
//		vettori macchine del traffico
...
//			posizione punteggio migliore e id css
			lBest.setLayoutX(15);
			lBest.setLayoutY(40);
			lBest.setId("best");
//			posizione punti e id css
			punti.setLayoutY(20);
			punti.setLayoutX(15);
			punti.setId("punti");
//			y e id css della strada
			stradaW.setY(y);
			stradaW.setId("strada");
//			x, y e grandezza di Bugs Bunny
			bugsW.setX(290);
			bugsW.setY(700);
...
//			creazione macchine del traffico
			crea(carW1,griglia2);
			crea(carW2,griglia2);
			crea(carW3,griglia2);
			crea(carW4,griglia2);
			crea(carW5,griglia2);
			crea(carW6,griglia2);
//			posizione x delle macchine del traffico
...
//			generazione posizione y delle macchine del traffico
			genera(carW1);
			genera2(carW2);
			genera(carW3);
			genera2(carW4);
...
//			aggiunge al Pane il giocatore e imposta la posizione x, y
			if(blu) {
...
//			evento alla chiusura della finestra
...
//			dimensione game over
			gameW.setFitHeight(210);
			gameW.setFitWidth(200);
//			x, y e id css scritta riavvia
...
//			  rotazione macchina
				if(e.getCode() == KeyCode.LEFT && vivo) {
					rotazione-=5;
				}
				
				if(e.getCode() == KeyCode.RIGHT && vivo) {
					rotazione+=5;
				}
//				fa ripartire il gioco
				...
				if(e.getCode() != KeyCode.RIGHT && e.getCode() != KeyCode.LEFT && vivo) {
					bugsW.setX(95);
					bugsW.setY(100);
				}
//				imposta rotazione al giocatore
				if(blu) {
...
//			genera y del traffico quando esce dallo schermo
			if(y1>=700) {
				genera(carW1);
			}
			if(y2>=700) {
...
//			collisioni traffico con giocatore
			if(gialla) {
...
//			label difficoltà impostata x, y e id css
			lDifficolta.setLayoutX(290);
			lDifficolta.setLayoutY(70);
			lDifficolta.setId("lDiff");
//			pulstanti selezione della difficoltà
//			id
...
//			pulsante salva ed esci azione, x, y e id
			bEsci.setOnAction(e->esci());
			bEsci.setLayoutX(300);
			bEsci.setLayoutY(340);
			bEsci.setId("esci");
//			git e immagini dimenzione e posizione
			giammaW.setX(0);
			giammaW.setY(152);
...
//			rotazione macchine e moto
	        ...
	        Button esci = new Button("Salva ed Esci");
...
//			posizione nomi macchine e moto
...
//	funzione per le collisioni tra giocatore e traffico
...
//	funzione per generare il traffico 1
...
//	funzione per generare il traffico 2
...
//	funzione per creare le macchine del traffico
